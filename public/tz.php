...
<div class="container">
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="3"><?php echo @get_current_user(); ?> - <?php echo $_SERVER['SERVER_NAME']; ?>
                (<?php echo @gethostbyname($_SERVER['SERVER_NAME']); ?>)&nbsp;&nbsp;你的 IP
                地址是：<?php echo @$_SERVER['REMOTE_ADDR']; ?> (<span id="iploc">未知位置</span>)
            </td>
        </tr>
        <tr>
            <td>服务器标识</td>
        ...
        <tr>
            <td>服务器操作系统</td>
            <td><?php echo @get_dist_name(); ?> &nbsp;内核版本：<?php if ('/' == DIRECTORY_SEPARATOR) {
        ...
        <tr>
            <td>服务器语言</td>
            <td><?php $lc_ctype = setlocale(LC_CTYPE, 0);
                echo $lc_ctype == 'C' ? 'POSIX' : $lc_ctype; ?></td>
            <td>服务器端口</td>
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <div class="progress">
                    <div id="barcpuPercent" class="progress-bar progress-bar-success" role="progressbar"
                         style="width:1px">&nbsp;
                    </div>
                </div>
            </td>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <div class="progress">
                    <div id="barmemPercent" class="progress-bar progress-bar-success" role="progressbar"
                ...
                if ($sysInfo['memCached'] > 0) {
                    ...
                    <span id="memCachedPercent"><?php echo $memCachedPercent; ?></span>%
                                                                                       | Buffers 缓冲为  <span
                            id="Buffers"><?php echo $mb; ?></span>
                    <div class="progress">
                        <div id="barmemCachedPercent" class="progress-bar progress-bar-info" role="progressbar"
                    ...
                    <div class="progress">
                        <div id="barmemRealPercent" class="progress-bar progress-bar-warning" role="progressbar"
                             style="width:<?php echo $memRealPercent ?>%"></div>
                    </div>
                    <?php
                }
                //判断如果 SWAP 区为0，不显示
                if ($sysInfo['swapTotal'] > 0) {
                    ...
                    <div class="progress">
                        <div id="barswapPercent" class="progress-bar progress-bar-danger" role="progressbar"
                             style="width:<?php echo $swapPercent ?>%"></div>
                    </div>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <div class="progress">
                    <div id="barhdPercent" class="progress-bar progress-bar-black" role="progressbar"
                         style="width:<?php echo $hdPercent ?>%"></div>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <table class="table table-striped table-bordered table-hover table-condensed">
            ...
            <?php for ($i = 2; $i < count($strs); $i++) : ?>
                ...
                <tr>
                    ...
                    <td style="width:29%">入网: <span class="text-info"
                                                    id="NetInput<?php echo $i ?>"><?php echo $NetInput[$i] ?></span>
                    </td>
                    <td style="width:14%">实时: <span class="text-info" id="NetInputSpeed<?php echo $i ?>">0B/s</span>
                    </td>
                    <td style="width:29%">出网: <span class="text-info"
                                                    id="NetOut<?php echo $i ?>"><?php echo $NetOut[$i] ?></span></td>
            ...
            <?php for ($i = 0; $i < count($strs); $i++) : ?>
                ...
                <?php if ('0x2' == $info[2] && !isset($seen[$info[3]])) : ?>
                    ...
                    <tr>
                        ...
                        <td>类型: <span class="text-info"><?php echo $info[1] == '0x1' ? 'ether' : $info[1]; ?></span>
                        </td>
    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        <tr>
            ...
            <td><?php $run_time = sprintf('%0.4f', microtime_float() - $time_start); ?>Processed
...
<script>
    ...
    function displayData(data) {
        ...
        $("#NetOutSpeed2").html(ForDight((data.NetOutSpeed2 - OutSpeed2), 3));
        OutSpeed2 = data.NetOutSpeed2;
        $("#NetOutSpeed3").html(ForDight((data.NetOutSpeed3 - OutSpeed3), 3));
        OutSpeed3 = data.NetOutSpeed3;
        $("#NetOutSpeed4").html(ForDight((data.NetOutSpeed4 - OutSpeed4), 3));
        OutSpeed4 = data.NetOutSpeed4;
        $("#NetOutSpeed5").html(ForDight((data.NetOutSpeed5 - OutSpeed5), 3));
        OutSpeed5 = data.NetOutSpeed5;
        $("#NetInputSpeed2").html(ForDight((data.NetInputSpeed2 - InputSpeed2), 3));
        InputSpeed2 = data.NetInputSpeed2;
        $("#NetInputSpeed3").html(ForDight((data.NetInputSpeed3 - InputSpeed3), 3));
        InputSpeed3 = data.NetInputSpeed3;
        $("#NetInputSpeed4").html(ForDight((data.NetInputSpeed4 - InputSpeed4), 3));
        InputSpeed4 = data.NetInputSpeed4;
        $("#NetInputSpeed5").html(ForDight((data.NetInputSpeed5 - InputSpeed5), 3));
        InputSpeed5 = data.NetInputSpeed5;
    }
